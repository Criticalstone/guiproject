...
public class Categories extends GridPane{
    ...
    private TitledPane initMeat(){
        ...
        buttons.add(new ToggleButton("N�tk�tt"));
        ...
        TitledPane res = new TitledPane("K�tt", inside);
//        res.getStyleClass().add("category-menu-list-item");
    ...
    private TitledPane initFriut(){
        List<ToggleButton> buttons = new ArrayList<>();
        buttons.add(new ToggleButton("B�r"));
        ...
        buttons.add(new ToggleButton("K�l"));
        buttons.add(new ToggleButton("Baljv�xter"));
        buttons.add(new ToggleButton("Potatis"));
        buttons.add(new ToggleButton("�rter"));
        ...
        VBox inside = new VBox();
        inside.getChildren().addAll(buttons);
        TitledPane res = new TitledPane("Frukt och gr�nt", inside);
        return res;
    }
    ...
    private TitledPane initPantry(){
        List<ToggleButton> buttons = new ArrayList<>();
        buttons.add(new ToggleButton("Br�d"));
        buttons.add(new ToggleButton("Mj�l"));
        buttons.add(new ToggleButton("Socker"));
        buttons.add(new ToggleButton("Salt"));
        buttons.add(new ToggleButton("N�tter & fr�n"));
    ...
    private TitledPane initSweet(){
        ToggleButton button = new ToggleButton("S�tsaker");
        button.setId("SWEET");
        button.addEventHandler(ActionEvent.ACTION, event -> buttonOnClick(event));
        button.setMinWidth(130);
        setButtonStyle(button);
        ...
        VBox inside = new VBox();
        inside.getChildren().add(button);
        TitledPane res = new TitledPane("S�tsaker", inside);
        return res;
    }
