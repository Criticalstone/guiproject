    ...
    public void setBanner(String n){
    	switch(n){
    		...
    		case "NUTS_AND_SEEDS":
    			...
    			bannerTitle.setText("N�tter & fr�n");
				break;
    		case "PASTA":	
